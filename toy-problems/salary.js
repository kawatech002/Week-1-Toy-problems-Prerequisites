...
// Define the net salary function passing the two arguments basic salary and benefits. 
function computeNetSalary(basicSalary, benefits) {
    const grossSalary = basicSalary + benefits;
    // //we now calculate NHIF deductuion 
    // NHIF deductions with a pay of between 0 and 5000
...
const benefits = 1000;
console.log(computeNetSalary(basicSalary, benefits));